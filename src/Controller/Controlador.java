...
import Model.fileManager.Hibernate; 
import View.Vista;
        ...
        while (!salir) {
            ...
            switch (tipoAcceso) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    // Crea una nueva instancia de ConexionMySQL y verifica la conexión
                    ...
                    break;
                case 5:
                    // Crea una nueva instancia de ConexionSQLite y verifica la conexión
                    accesoDatos = new ConexionSQLite();
                    if (accesoDatos.conectar() != null) { 
